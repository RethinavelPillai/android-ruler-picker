 ...
 *
 * @version 1.1
 * @author Sumeet Kumar <sumeetgehi@gmail.com>
 */
public final class VerticalRulerValuePicker extends FrameLayout implements ObservableVerticalScrollView.ScrollChangedListener {
     ...
     * Public constructor.
     */
    public VerticalRulerValuePicker(@NonNull final Context context) {
        super(context);
        init(null);
    }
    ...
    private void addChildViews() {
        ...
        mScrollView.setVerticalScrollBarEnabled(false); //Don't display the scrollbar
